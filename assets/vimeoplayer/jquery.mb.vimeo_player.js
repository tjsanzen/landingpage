...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (e, b, a) {
...
$jscomp.polyfill = function (e, b, a, d) {
    if (b) {
        ...
        d = a[e];
        b = b(d);
        b != d && null != b && $jscomp.defineProperty(a, e, {
            configurable: !0,
            writable: !0,
            value: b
        })
...
$jscomp.polyfill("Array.prototype.find", function (e) {
    return e ? e : function (b, a) {
        return $jscomp.findInternal(this, b, a).v
    }
}, "es6", "es3");
var get_vimeo_videoID = function (e) {
    return 0 < e.indexOf("vimeo.com") ? e.substr(e.lastIndexOf("/") + 1, e.length) : 15 < e.length ? null : e
};
(function (e) {
    jQuery.vimeo_player = {
        ...
        buildPlayer: function (b) {
            ...
            return this.each(function () {
                ...
                var e = d.data("property") && "string" ==
                    typeof d.data("property") ? eval("(" + d.data("property") + ")") : d.data("property");
                ...
                c.canGoFullScreen = !(jQuery.browser.msie || jQuery.browser.opera || a());
                c.canGoFullScreen || (c.opt.realfullscreen = !1);
                c.isAlone = !1;
                c.hasFocus = !0;
                c.videoID = this.opt.videoURL ? get_vimeo_videoID(this.opt.videoURL) : d.attr("href") ? get_vimeo_videoID(d.attr("href")) :
                    !1;
                c.isSelf = "self" == c.opt.containment;
                c.opt.containment = "self" == c.opt.containment ? jQuery(this) : jQuery(c.opt.containment);
                ...
                if (!c.isBackground || !c.backgroundIsInited) {
                    ...
                    var g = "vimeo_player_" + c.id,
                        f = jQuery("<div/>").addClass("vimeo_player_wrapper").attr("id", "vimeo_player_wrapper_" +
                            g);
                    f.css({
                        position: "absolute",
                        zIndex: 0,
                    ...
                    c.playerBox.css({
                        ...
                        src: "https://player.vimeo.com/video/" + c.videoID + "?background=1&autopause=0"
                    });
                    if (!jQuery.browser.mobile || c.canPlayOnMobile) {
                        f.append(c.playerBox);
                        c.opt.containment.children().not("script, style").each(function () {
                            "static" ==
                            jQuery(this).css("position") && jQuery(this).css("position", "relative")
                        });
                        c.isBackground ? (jQuery("body").css({
                            ...
                            left: 0,
                            zIndex: 0
                        })) : "static" == c.opt.containment.css("position") && c.opt.containment.css({
                            position: "relative"
                        });
                        ...
                        if (!c.isBackground) e.on("mouseenter", function () {
                            c.controlBar && c.controlBar.length && c.controlBar.addClass("visible")
                        }).on("mouseleave",
                            function () {
                                c.controlBar && c.controlBar.length && c.controlBar.removeClass("visible")
                            });
                        jQuery(document).on("vimeo_api_loaded", function () {
                            ...
                            c.player.ready().then(function () {
                                function a() {
                                    c.isReady = !0;
                                    c.opt.mute && setTimeout(function () {
                                        d.v_mute()
                                    }, 1E3);
                                    c.opt.showControls && jQuery.vimeo_player.buildControls(c);
                                    c.opt.autoPlay ? setTimeout(function () {
                                        d.v_play();
                                        setTimeout(function () {
                                ...
                                var b;
                                c.opt.startAt ? (c.player.play().then(function () {
                                    c.player.pause()
                                }), d.v_seekTo(c.opt.startAt, function () {
                                    a()
                                })) : a();
                                d.v_optimize_display();
                                jQuery(window).off("resize.vimeo_player_" + c.id).on("resize.vimeo_player_" + c.id, function () {
                                    d.v_optimize_display()
                                });
                                ...
                                c.player.on("play", function (a) {
                                    ...
                                    c.controlBar && c.controlBar.length &&
                                        c.controlBar.find(".vimeo_player_pause").html(jQuery.vimeo_player.controls.pause);
                                    "undefined" != typeof _gaq && eval(c.opt.gaTrack) && _gaq.push(["_trackEvent", "vimeo_player", "Play", c.videoID]);
                                    "undefined" != typeof ga && eval(c.opt.gaTrack) && ga("send", "event", "vimeo_player", "play", c.videoID);
                                ...
                                c.player.on("pause", function (a) {
                                    c.state = 2;
                                    d.trigger("change_state");
                                    c.controlBar && c.controlBar.length && c.controlBar.find(".vimeo_player_pause").html(jQuery.vimeo_player.controls.play);
                                ...
                                c.player.on("timeupdate", function (a) {
                                    ...
                                    c.opt.stopMovieOnBlur && !document.hasFocus() && 1 == c.state && (c.hasFocus = !1, d.v_pause(), c.document_focus =
                                        setInterval(function () {
                                            document.hasFocus() && !c.hasFocus && (c.hasFocus = !0, d.v_play(), clearInterval(c.document_focus))
                                        }, 300));
                                    if (c.opt.showControls) {
                                        ...
                                        a.duration ? c.controlBar.find(".vimeo_player_time").html(jQuery.vimeo_player.formatTime(a.seconds) +
                                            " / " + jQuery.vimeo_player.formatTime(a.duration)) : c.controlBar.find(".vimeo_player_time").html("-- : -- / -- : --")
                                    }
                                    c.opt.addRaster ? (f = "dot" == c.opt.addRaster ? "raster-dot" : "raster", c.overlay.addClass(c.isRetina ? f + " retina" : f)) : c.overlay.removeClass(function (a, b) {
                                        a = b.split(" ");
                                        var c = [];
                                    ...
                                    c.opt.stopAt = c.opt.stopAt > a.duration ? a.duration - .6 : c.opt.stopAt;
                                    a.seconds >= (c.opt.stopAt || a.duration - .6) && (c.loop = c.loop ||
                                        0, c.opt.loop && c.loop < c.opt.loop ? (d.v_seekTo(c.opt.startAt), c.loop++) : (d.v_pause(), c.state = 0, d.trigger("change_state")));
                            ...
                            d.on("change_state", function () {
                                ...
                                0 == c.state && c.wrapper.fadeOut(500, function () {
                                    d.v_seekTo(0)
                                })
                            })
                        })
                    } else c.opt.mobileFallbackImage && f.css({
        ...
        play: function () {
            ...
            a.length && a.find(".mb_YTPPvimeo_player_playpause").html(jQuery.vimeo_player.controls.pause);
            b.state = 1;
        ...
        seekTo: function (b, a) {
            var d = this.get(0);
            d.player.setCurrentTime(d.opt.stopAt && b >= d.opt.stopAt ? d.opt.stopAt - .5 : b).then(function (b) {
        ...
        setVolume: function (b) {
            ...
            b || a.opt.vol || !a.isMute ? !b && !a.isMute || b && a.opt.vol == b ? a.isMute ? jQuery(a).v_mute() :
                jQuery(a).v_unmute() : (a.opt.vol = b, a.player.setVolume(a.opt.vol), a.volumeBar && a.volumeBar.length && a.volumeBar.updateSliderVal(100 * b)) : jQuery(a).v_unmute();
            return this
        },
        ...
        buildControls: function (b) {
            ...
            if (!jQuery("#controlBar_" + b.id).length) {
                ...
                var d = jQuery("<div/>").addClass("buttonBar"),
                    c = jQuery("<span>" + jQuery.vimeo_player.controls.play + "</span>").addClass("vimeo_player_pause vimeo_icon").click(function () {
                        1 ==
                            b.state ? jQuery(b).v_pause() : jQuery(b).v_play()
                    }),
                    e = jQuery("<span>" + jQuery.vimeo_player.controls.mute + "</span>").addClass("vimeo_player_muteUnmute vimeo_icon").click(function () {
                        b.isMute ? jQuery(b).v_unmute() : jQuery(b).v_mute()
                    }),
                    h = jQuery("<div/>").addClass("vimeo_player_volume_bar").css({
                        display: "inline-block"
                    });
                b.volumeBar = h;
                var g = jQuery("<span/>").addClass("vimeo_player_time"),
                    f = "https://vimeo.com/" + b.videoID,
                    k = jQuery("<span/>").html(jQuery.vimeo_player.controls.logo).addClass("vimeo_url vimeo_icon").attr("title",
                        "view on Vimeo").on("click", function () {
                        console.debug(f);
                        window.open(f, "viewOnVimeo")
                    }),
                    m = jQuery("<span/>").html(jQuery.vimeo_player.controls.fullscreen).addClass("vimeo_fullscreen vimeo_icon").on("click", function () {
                        jQuery(b).v_fullscreen(a.realfullscreen)
                    }),
                    n = jQuery("<div/>").addClass("vimeo_player_pogress").css("position", "absolute").click(function (a) {
                        p.css({
                            width: a.clientX - p.offset().left
                        });
                    ...
                    p = jQuery("<div/>").addClass("vimeo_player_seek_bar").css("position", "absolute");
                n.append(q).append(p);
                d.append(c).append(e).append(h).append(g);
                a.show_vimeo_logo && d.append(k);
                (b.isBackground || eval(b.opt.realfullscreen) && !b.isBackground) && d.append(m);
        ...
        optimizeVimeoDisplay: function (b) {
            ...
            a.opt.align = "undefined " != typeof a.opt.align ? a.opt.align : "center,center";
            b = a.opt.align.split(",");
            if (a.opt.optimizeDisplay) {
                ...
                c = e;
                var g = "16/9" == a.opt.ratio ? Math.ceil(.5625 * c) : Math.ceil(.75 * c);
                var f = -((g - h) / 2);
                var k = 0;
                var m = g < h;
                m && (g = h + d, c = "16/9" == a.opt.ratio ? Math.floor(16 / 9 * g) : Math.floor(4 / 3 * g), f = 0, k = -((c - e) / 2));
                for (var n in b)
                    if (b.hasOwnProperty(n)) switch (b[n].replace(/ /g, "")) {
                        case "top":
                            f = m ? -((g - h) / 2) : 0;
                            break;
                        case "bottom":
        ...
        fullscreen: function (b) {
            function a(a, b) {
                for (var c = ["webkit", "moz", "ms", "o", ""], d = 0, e, f; d < c.length && !a[e];) {
                    e = b;
            ...
            b = eval(b);
            var h = jQuery("#controlBar_" +
                    d.id),
                g = h.find(".vimeo_fullscreen"),
                f = d.isSelf ? d.opt.containment : d.wrapper;
            if (b) {
                var k = jQuery.browser.mozilla ? "mozfullscreenchange" : jQuery.browser.webkit ? "webkitfullscreenchange" : "fullscreenchange";
                jQuery(document).off(k).on(k, function () {
                    a(document, "IsFullScreen") || a(document, "FullScreen") ? e = jQuery.Event("VPFullScreenStart") : (d.isAlone = !1, g.html(jQuery.vimeo_player.controls.fullscreen), f.removeClass("vimeo_player_Fullscreen"), f.fadeTo(500, d.opt.opacity), f.css({
                            zIndex: 0
                        }), d.isBackground ? jQuery("body").after(h) :
                        d.wrapper.before(h), jQuery(window).resize(), e = jQuery.Event("VPFullScreenEnd"));
                    c.trigger(e)
                })
            }
            if (d.isAlone) jQuery(document).off("mousemove.vimeo_player"), clearTimeout(d.hideCursor), d.overlay.css({
                cursor: "auto"
            }), b ? (a(document, "FullScreen") || a(document, "IsFullScreen")) && a(document, "CancelFullScreen") : f.fadeTo(1E3, d.opt.opacity).css({
                zIndex: 0
            }), g.html(jQuery.vimeo_player.controls.fullscreen), d.isAlone = !1;
            else {
                var m = function () {
                    d.overlay.css({
                        cursor: "none"
                ...
                jQuery(document).on("mousemove.vimeo_player",
                    function (a) {
                        ...
                        jQuery(a.target).parents().is(".vimeo_player_bar") || (d.hideCursor = setTimeout(m, 3E3))
                    });
                m();
                b ? (f.css({
                    opacity: 0
                }), f.addClass("vimeo_player_Fullscreen"), a(f.get(0), "RequestFullScreen"), setTimeout(function () {
                    f.fadeTo(1E3, 1);
                    d.wrapper.append(h);
    ...
    e.simpleSlider = {
        ...
        init: function (b) {
            return this.each(function () {
                ...
                d.updateSliderVal();
                a.opt.readonly || (d.on(e.simpleSlider.events.start, function (b) {
                    ...
                    b.preventDefault();
                    b.stopPropagation()
                }), e(document).on(e.simpleSlider.events.move, function (b) {
                    e.browser.mobile && (b = b.changedTouches[0]);
                    a.canSlide && (e(document).css({
                            cursor: "default"
                        }),
        ...
        updateSliderVal: function (b) {
            ...
            if (a.opt) {
                ...
                var d = e(a).outerWidth(),
                    c = e(a).outerHeight();
                a.x = "object" == typeof b ? b.clientX + document.body.scrollLeft - this.offset().left : "number" == typeof b ? b * d / a.opt.scale : a.opt.initialval * d / a.opt.scale;
                a.y = "object" == typeof b ? b.clientY + document.body.scrollTop - this.offset().top : "number" == typeof b ? (a.opt.scale - a.opt.initialval - b) * c / a.opt.scale : a.opt.initialval * c / a.opt.scale;
                ...
                "h" == a.opt.orientation ? a.level.width(Math.floor(100 * a.x / d) + "%") : a.level.height(Math.floor(100 * a.y / c));
